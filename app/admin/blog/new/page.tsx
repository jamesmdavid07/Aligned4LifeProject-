...
export default function NewBlogPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus({ type: 'success', message: result.message || 'Blog saved successfully.' });
      ...
      <div className="mx-auto max-w-5xl rounded-2xl border border-white/10 bg-navy-700/60 p-6 shadow-2xl shadow-black/30 sm:p-8 lg:p-10">
        ...
        <div className="mb-8 border-b border-white/10 pb-6">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-navy-100 sm:text-base">
            Create a new weekly blog reflection. Published content goes live on the blog automatically.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label htmlFor="theme" className="text-sm font-medium text-navy-100">
              Theme
            </label>
            <input
              id="theme"
          ...
          <div className="space-y-2">
            <label htmlFor="subtitle" className="text-sm font-medium text-navy-100">
              Subtitle
            </label>
            <input
              id="subtitle"
          ...
          <div className="space-y-2">
            <label htmlFor="keyText" className="text-sm font-medium text-navy-100">
              Key Text
            </label>
            <textarea
              id="keyText"
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="space-y-2">
              <label htmlFor="weekNumber" className="text-sm font-medium text-navy-100">
                Week Number
              </label>
              <input
                id="weekNumber"
            ...
            <div className="space-y-2">
              <label htmlFor="publishDate" className="text-sm font-medium text-navy-100">
                Publish Date
              </label>
              <input
                id="publishDate"
          ...
          <div className="space-y-2">
            <label htmlFor="content" className="text-sm font-medium text-navy-100">
              Blog Content
            </label>
            <textarea
              id="content"
